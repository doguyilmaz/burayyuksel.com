  ...
  return (
    <Box bg='#000' h='100vh' overflow='hidden'>
      ...
      >
        ...
        <Heading fontSize='91px' lineHeight='91px' mt={5} fontFamily='Poppins' fontWeight={275} color='#FFFFFF'>
          Buray Yüksel
        </Heading>
        <Heading fontWeight={400} fontSize='140px' lineHeight='91px' mt={5} fontFamily='GopherDisplay' color='#FFFFFF'>
          Product Designer
        </Heading>
